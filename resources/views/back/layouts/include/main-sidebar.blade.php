...
{{--                    <li><a href="{{route('admin.post')}}"><i class="icon-magazine"></i> <span>Xəbərlər</span></a>--}}
                    <li><a href="{{route('admin.category.index')}}"><i class=" fa fa-th-list"></i> <span>Categorys</span></a>


                    <li><a><i class=" fa fa-th-list"></i> <span>Products</span></a>

                        <ul class="navigation navigation-main navigation-accordion">
                            @if(count($categorys)>0)
                                @foreach($categorys as $category)
                                    <li><a href="{{route('admin.product.index',$category->id)}}">
{{--                                            <i class=" icon-bookmark"></i> --}}
                    ...
                    <li><a href="{{route('admin.order.index')}}"><i class="fa fa-first-order"></i> <span>Orders</span></a></li>
                    ...
                    <li><a href="{{route('admin.slider.index')}}"><i class="fa fa-cogs"></i> <span>Slider</span></a></li>
                    <li><a href="{{route('ll.list')}}"><i class="fa fa-transgender"></i> <span>Translate</span></a></li>
                    <li><a class="nav-link" href="">Tərcümələr</a></li>
